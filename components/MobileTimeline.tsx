            ...
            <Link href="gallery">
              <a className="w-5/6 aspect-[5/3] rounded-lg shadow-lg bg-white flex flex-row overflow-hidden">
                ...
                <div className="w-3/5 p-3 xs:p-8 sm:p-10 flex flex-col justify-between">
                  <div>
                    <p className="heading font-wenyue underline mb-3">
                      {e.title}
                    </p>
                    <p className="font-wenyue line-clamp-6 xs:line-clamp-10 ">
                      {e.description}
                    </p>
                  </div>
                  <p className="font-wenyue  text-indigo-600">
                    {L().events.date}: {e.date}
                  </p>
                </div>
              </a>
            </Link>
